...
import net.syrupstudios.wellseasoned.data.CookingReloadListener;
...
public final class NeoForgeWellSeasoned {
    ...
    private void addReloadListeners(AddReloadListenerEvent event) {
        for (CookingReloadListener.Kind kind : CookingReloadListener.Kind.values()) {
            event.addListener(new CookingReloadListener(WellSeasoned.COOKING_DATA, kind));
        }
    }
}
//?}
